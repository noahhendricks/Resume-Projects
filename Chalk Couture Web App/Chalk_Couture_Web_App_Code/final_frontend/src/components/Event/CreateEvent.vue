    ...
    <div class="row justify-content-center"> 
        ...
        <br><br><p><button class="btn goback" @click="$router.go(-1)">Go Back!</button></p>
            <div style="margin-left:525px; margin-top: -50px" >
                <u class="text-center" style="font-size:200%; font-weight:bold; ">Create Chalk Event</u>
            </div><br>
            ...
            <div class="form-group col-lg-auto">
                    ...
                    <input type="text" size="46" class="form-control" placeholder="3004 Pilgrims Point Ln" minlength="5" maxlength="45" pattern="[a-zA-Z\d\s\-\,\#\.\+]{5,55}"   v-model="event.event_street" required>
...
<script>
    ...
    export default {
        data() {
            return {
                //retrieving data from the event schema getting the data 
                errors: [],
                event: {
                   event_name: '',
                   event_type: 'Indoor',
        ...
        methods: {
            handleSubmitForm() {
                ...
                //posing data that has been created to route passing the event schema data
                let apiURL = 'http://localhost:27017/event';
