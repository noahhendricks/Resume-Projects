    ...
    <div class="row justify-content-center"> 
        ...
        <br><br><p><button class="btn goback" @click="$router.go(-1)">Go Back!</button></p>
            <div style="margin-left:525px; margin-top: -50px" >
                <u class="text-center" style="font-size:200%; font-weight:bold; ">Create Chalk Item</u>
            </div><br>
            ...
            <form @submit.prevent="handleSubmitForm">
                ...
                <div class="form-group col-lg-auto">
                    ...
                    <label style ="font-size:14pt; color:red; font-weight:bold"> * </label>
                     <input size="13"  type="text"  class="form-control" id="inputProjectNotess" minlength="2" maxlength="12"  placeholder="C223R4"  rows="1" v-model="item.item_ID" required>
                </div>
...
<script>
    ...
    export default {
        data() {
            return {
                //retrieving data from the Item schema getting the data 
                errors: [],
                item: {
                   item_ID: '',
                   item_name: '',
        ...
        methods: {
            handleSubmitForm() {
                ...
                //posing data that has been created to route passing the Item schema data
                let apiURL = 'http://localhost:27017/item';
