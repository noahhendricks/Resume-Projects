<template>
    <div class="row">
        ...
        <div class="col-lg-12"><br>
          <u style="margin-left:475px;" class="projectReport">Event Sales Report</u>
          <br>
            ...
            <table class="styled-table">
                ...
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th style="position: sticky;" ><mark>Event Name</mark></th>
                ...
                <tbody>
                    ...
                    <tr v-for="event_invoice in event_invoices" :key="event_invoice.event_invoice_number">
                        ...
                        <td style="position: relative; text-align:left" >{{event_invoice.event_ID}}</td>
                        <td style="position: relative; text-align:left" >{{event_invoice.event_name}} </td>
...
<script>
    ...
    //pass data values from the event invoices and items
    export default {
        data() {
            return {
            //retrieving data from the items and event invoices schema getting the data 
                event_invoices: [], 
        ...
        created() {
            let apiURL = `http://localhost:27017/item_event_sale_report/${this.$route.params.id}`;
